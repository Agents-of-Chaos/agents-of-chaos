...
def manual_punctuation_glyph(ch: str) -> tuple[object, int]:
    dot = [(62, 0), (150, 0), (150, 88), (62, 88)]
    comma_tail = [(106, -95), (168, 0), (112, 0), (50, -95)]
    if ch == ".":
        return make_manual_glyph([dot], 230)
    if ch == ",":
        return make_manual_glyph([dot, comma_tail], 230)
    if ch == ":":
        return make_manual_glyph([dot, [(62, 292), (150, 292), (150, 380), (62, 380)]], 230)
    if ch == ";":
        return make_manual_glyph([dot, comma_tail, [(62, 292), (150, 292), (150, 380), (62, 380)]], 230)
    if ch in {"'", "’"}:
        return make_manual_glyph([[(70, 320), (150, 320), (150, 520), (70, 520)]], 220)
    if ch == '"':
        return make_manual_glyph(
            [
                [(62, 320), (142, 320), (142, 520), (62, 520)],
                [(202, 320), (282, 320), (282, 520), (202, 520)],
            ],
            345,
        )
    if ch == "-":
        return make_manual_glyph([[(58, 205), (320, 205), (320, 285), (58, 285)]], 380)
    if ch == "_":
        return make_manual_glyph([[(48, -95), (342, -95), (342, -25), (48, -25)]], 390)
    if ch == "!":
        return make_manual_glyph([[(70, 150), (150, 150), (150, 520), (70, 520)], dot], 230)
    if ch == "?":
        return make_manual_glyph(
            [
                [(74, 438), (128, 520), (360, 520), (430, 450), (430, 340), (350, 340), (350, 430), (166, 430), (146, 390)],
                [(350, 340), (430, 340), (430, 260), (316, 190), (260, 248)],
                dot,
            ],
            500,
        )
    if ch == "/":
        return make_manual_glyph([[(92, 0), (180, 0), (392, 520), (304, 520)]], 480)
    if ch == "\\":
        return make_manual_glyph([[(300, 0), (388, 0), (176, 520), (88, 520)]], 480)
    if ch == "|":
        return make_manual_glyph([[(76, -95), (156, -95), (156, 520), (76, 520)]], 230)
    if ch == "(":
        return make_manual_glyph([[(240, 0), (150, 0), (74, 90), (74, 430), (150, 520), (240, 520), (154, 408), (154, 112)]], 300)
    if ch == ")":
        return make_manual_glyph([[(60, 0), (150, 0), (226, 90), (226, 430), (150, 520), (60, 520), (146, 408), (146, 112)]], 300)
    if ch == "[":
        return make_manual_glyph([[(70, 0), (270, 0), (270, 72), (150, 72), (150, 448), (270, 448), (270, 520), (70, 520)]], 330)
    if ch == "]":
        return make_manual_glyph([[(60, 0), (260, 0), (260, 520), (60, 520), (60, 448), (180, 448), (180, 72), (60, 72)]], 330)
    if ch == "{":
        return make_manual_glyph(
            [[(280, 0), (170, 0), (124, 48), (124, 204), (70, 230), (124, 256), (124, 472), (170, 520), (280, 520), (216, 430), (216, 292), (152, 230), (216, 168), (216, 90)]],
            350,
        )
    if ch == "}":
        return make_manual_glyph(
            [[(70, 0), (180, 0), (226, 48), (226, 204), (280, 230), (226, 256), (226, 472), (180, 520), (70, 520), (134, 430), (134, 292), (198, 230), (134, 168), (134, 90)]],
            350,
        )
    if ch == "+":
        return make_manual_glyph([[(170, 110), (250, 110), (250, 220), (360, 220), (360, 300), (250, 300), (250, 410), (170, 410), (170, 300), (60, 300), (60, 220), (170, 220)]], 420)
    if ch == "=":
        return make_manual_glyph([[(62, 165), (360, 165), (360, 235), (62, 235)], [(62, 295), (360, 295), (360, 365), (62, 365)]], 420)
    if ch == "<":
        return make_manual_glyph([[(330, 120), (330, 210), (148, 260), (330, 310), (330, 400), (58, 310), (58, 210)]], 390)
    if ch == ">":
        return make_manual_glyph([[(58, 120), (58, 210), (240, 260), (58, 310), (58, 400), (330, 310), (330, 210)]], 390)
    if ch == "*":
        return make_manual_glyph(
            [
                [(188, 292), (242, 292), (242, 500), (188, 500)],
                [(98, 372), (332, 372), (332, 426), (98, 426)],
                [(126, 482), (166, 522), (320, 312), (280, 272)],
                [(126, 272), (166, 312), (320, 522), (280, 482)],
            ],
            430,
        )
    if ch == "`":
        return make_manual_glyph([[(88, 520), (178, 520), (260, 350), (178, 350)]], 330)
    if ch == "~":
        return make_manual_glyph(
            [[(60, 265), (120, 340), (210, 310), (300, 265), (356, 340), (430, 340), (360, 200), (282, 200), (194, 245), (120, 200)]],
            500,
        )
